      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link href={user ? "/account" : "/login"} className="p-2 text-text-body hover:text-terracotta transition-colors hidden sm:block">
              <User size={20} />
            </Link>

            <Link href="/watchlist" className="p-2 text-text-body hover:text-terracotta transition-colors relative">
              <Heart size={20} />
              {wishlist.length > 0 && (
