...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-terracotta text-white hover:bg-[#6D4A30] focus:ring-terracotta',
    secondary: 'bg-teal text-white hover:bg-[#0A3642] focus:ring-teal',
    outline: 'border-2 border-terracotta text-terracotta hover:bg-terracotta hover:text-white focus:ring-terracotta',
    ghost: 'text-text-body hover:bg-gray-100 focus:ring-gray-500',
  };
