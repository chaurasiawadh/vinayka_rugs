...
const AppointmentModal: React.FC<AppointmentModalProps> = ({ isOpen, onClose, eventName }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.phone.replace(/[^0-9]/g, '').match(phoneRegex)) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="flex justify-between items-center p-5 border-b border-gray-100 bg-cream">
          <h2 id="modal-title" className="text-xl font-serif text-text-body">Request Appointment</h2>
          <button onClick={onClose} className="p-2 hover:bg-black/5 rounded-full transition-colors" aria-label="Close modal">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="overflow-y-auto p-6">
          <form id="appointment-form" onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1" htmlFor="name">Full Name <span className="text-error">*</span></label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="email">Email <span className="text-error">*</span></label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="phone">Phone <span className="text-error">*</span></label>
                <input
                  type="tel"
                  id="phone"
                  name="phone"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="date">Preferred Date <span className="text-error">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="time">Preferred Time</label>
                <div className="relative">
                  <select
                    name="time"
                    id="time"
            ...
            <div>
              <label className="block text-sm font-medium mb-1" htmlFor="message">Message (Optional)</label>
              <textarea
                id="message"
                name="message"
                rows={3}
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <label htmlFor="consent" className="text-xs text-gray-600">
                I agree to receive appointment updates and communications via WhatsApp & Email. I understand that my data will be handled according to the <a href="/privacy" className="underline text-terracotta">Privacy Policy</a>.
              </label>
            </div>
          </form>
        </div>
        ...
        <div className="p-5 border-t border-gray-100 bg-white flex justify-end gap-3">
          <Button onClick={onClose} type="button" className="bg-transparent text-text-body hover:bg-gray-100 shadow-none">Cancel</Button>
          <Button type="submit" form="appointment-form" disabled={loading} className="min-w-[140px]">
