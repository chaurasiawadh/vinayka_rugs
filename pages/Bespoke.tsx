    ...
    <div className="bg-cream animate-fade-in">
      ...
      <section className="relative h-[80vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
            <span className="text-white/90 text-sm tracking-[0.3em] uppercase mb-4 animate-slide-up">The Atelier</span>
            <h1 className="text-5xl md:text-7xl font-serif text-white mb-6 animate-slide-up">Your Vision, <br/> <span className="italic font-light">Handcrafted</span></h1>
            <p className="text-xl text-gray-100 max-w-2xl mb-8 font-light animate-slide-up">
                Collaborate with our master weavers to create a rug that is uniquely yours. From color matching to custom dimensions, the possibilities are infinite.
            </p>
            <div className="animate-slide-up">
                <Button size="lg" onClick={() => openBespokeModal('Bespoke Landing Hero')}>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              ...
              {[
                  { icon: <MessageCircle size={24} />, title: "Consultation", desc: "Share your inspiration, color palette, and requirements with our design team." },
                  { icon: <Palette size={24} />, title: "Design & Artwork", desc: "Receive digital renderings and material swatches for approval." },
                  { icon: <Scissors size={24} />, title: "Weaving", desc: "Our artisans hand-knot your rug using age-old techniques. Updates provided." },
                  { icon: <Truck size={24} />, title: "Delivery", desc: "White-glove delivery and installation in your home." }
              ].map((step, i) => (
                  <div key={i} className="flex flex-col items-center text-center bg-cream">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-white p-12 lg:p-24 flex flex-col justify-center">
              <span className="text-terracotta uppercase tracking-widest text-xs font-bold mb-4">Materials</span>
              <h2 className="text-4xl font-serif mb-6">Uncompromising Quality</h2>
              <p className="text-text-muted text-lg leading-relaxed mb-8">
                  We source only the finest materials for our bespoke creations. Choose from high-altitude Himalayan wool, lustrous bamboo silk, or durable natural jute. Our dyeing process allows for over 2,000 color variations, ensuring a perfect match for your interior.
              </p>
              <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center"><PenTool size={14}/></div>
                      <span className="font-medium">Custom Shapes</span>
                  </div>
                  <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center"><Palette size={14}/></div>
                      <span className="font-medium">Pantone Matching</span>
                  </div>
              </div>
              <div>
                <Button variant="outline" onClick={() => openBespokeModal('Materials Section')}>Request Sample Kit</Button>
              </div>
          </div>
      </section>
      ...
      {/* Inspiration Gallery */}
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-serif mb-12 text-center">Recent Commissions</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                  ...
                  <div key={i} className="group relative overflow-hidden rounded-lg aspect-[3/4]">
                      <ImageSmart src={src} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
