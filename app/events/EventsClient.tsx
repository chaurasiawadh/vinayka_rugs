...
const EventsClient: React.FC = () => {
  ...
  const galleryImages = [
    ...
    'https://images.unsplash.com/photo-1560457079-9a6532ccb118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-20">
          <div className="animate-slide-up max-w-3xl">
            ...
            <p className="text-xl text-gray-200 font-light mb-8 max-w-2xl leading-relaxed">
              Join Vinayka Rugs at the country&apos;s most definitive design
              week. Experience the launch of our &apos;Manchaha&apos;
              collection.
            </p>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            <div>
              <h2 className="text-3xl font-serif text-text-body mb-6">
                The &apos;Manchaha&apos; Installation
              </h2>
              <p className="text-text-muted leading-relaxed text-lg mb-6">
                For the first time in Delhi, experience our award-winning
                &apos;Manchaha&apos; (My Heart&apos;s Desire) collection. This
                initiative empowers weavers to create their own designs,
                resulting in raw, unscripted art pieces that tell personal
                stories of village life, dreams, and culture.
              </p>
              <p className="text-text-muted leading-relaxed text-lg">
                Our booth at Pavilion 3 is designed as an immersive journey
                through the rural landscapes of Rajasthan. Visitors will have
                the opportunity to interact with the master weavers and
                understand the zero-waste philosophy behind these unique rugs.
              </p>
            </div>
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="bg-cream rounded-xl p-8 border border-gray-100 shadow-sm">
                ...
                <p className="text-sm text-text-muted mb-6">
                  Schedule a dedicated time with our consultants at the event
                  for B2B enquiries or bespoke consultations.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-6">
                ...
                <p className="text-text-muted text-sm mb-4 line-clamp-2">
                  Paris Design Week. Discover our new Silk Route edit inspired
                  by the dunes of Jaisalmer.
                </p>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-6">
                ...
                <p className="text-text-muted text-sm mb-4 line-clamp-2">
                  The world&apos;s most important furniture fair. We will be
                  showcasing large format installations.
                </p>
                <div className="flex items-center text-sm text-text-muted mb-6">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
              ...
              <div className="p-6">
                ...
                <p className="text-text-muted text-sm mb-4 line-clamp-2">
                  Middle East&apos;s leading design fair. Exploring the
                  intersection of traditional craft and modern luxury.
                </p>
                <div className="flex items-center text-sm text-text-muted mb-6">
