...
const Login: React.FC = () => {
  ...
  const validateRegister = () => {
    ...
    else if (!phoneRegex.test(regData.phone))
    ...
    else if (!passRegex.test(regData.password))
      errors.password = 'Must have 8+ chars, 1 uppercase, 1 number';
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row animate-fade-in">
      ...
      <div className="flex-1 flex flex-col justify-center p-6 sm:p-12 lg:p-16 overflow-y-auto">
        ...
        {notification && (
          <div
            className={`mb-6 p-4 rounded-lg flex items-center gap-3 text-sm font-medium animate-slide-up ${notification.type === 'success' ? 'bg-success/10 text-success' : 'bg-error/10 text-error'}`}
          >
            ...
            <div className="animate-fade-in">
              <div className="mb-8">
                ...
                <p className="text-text-muted text-sm">
                  Sign in to access your orders, watchlist, and bespoke
                  requests.
                </p>
              </div>
              ...
              <form onSubmit={handleRegister}>
                ...
                <div className="mb-6">
                  <p className="text-[10px] text-gray-500 leading-relaxed">
                    ...
                    Privacy Policy. Password must contain at least 8 characters,
