        ...
        <div className="bg-white min-h-screen font-sans text-text-body animate-fade-in">
            ...
            <nav className="border-b border-gray-100 py-3">
                <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 text-xs text-text-muted flex items-center gap-2">
                    ...
                    <Link href="/shop" className="hover:text-terracotta transition-colors">{product.category}</Link>
                    <span className="text-gray-300">/</span>
                    {product.collection && (
                        <>
                            <Link href={`/shop?collection=${product.collection}`} className="hover:text-terracotta transition-colors">{product.collection}</Link>
                            <span className="text-gray-300">/</span>
                        </>
                    )}
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {product.sizes?.map(size => (
                                            <button
                                                ...
                                                className={`px-4 py-3 text-sm rounded border transition-all duration-200 ${selectedSize === size
