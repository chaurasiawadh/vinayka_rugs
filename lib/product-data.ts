export const PRODUCTS = [
  {
    ...
    careInstructions:
      'Vacuum regularly on a low setting without a beater bar. blot spills immediately with a clean, white cloth. Professional rug cleaning recommended every 3-5 years.',
...
export const REVIEWS = [
  {
    ...
    date: '2 weeks ago',
    content:
      'The quality of this rug is outstanding. It totally transformed my living room. The wool is so soft and the colors are even more beautiful in person.',
  ...
  },
  {
    ...
    date: '1 month ago',
    content:
      "Exceptional craftsmanship. You can tell it's hand-knotted. Customer service was also very helpful with sizing questions.",
  },
];
...
export const FAQS = [
  {
    ...
    answer:
      'A general rule is to leave 12-18 inches of floor exposed on all sides. For living rooms, ensure at least the front legs of furniture are on the rug.',
  },
  {
    question: 'Do you offer custom sizes?',
    answer:
      'Yes, as a bespoke manufacturer, we can create this design in any size or shape. Please contact our Bespoke team for a quote.',
  },
  {
    question: 'What is your return policy?',
    answer:
      'We offer a 30-day return policy for standard sizes. Custom orders are final sale.',
  },
  {
    question: 'Is padding recommended?',
    answer:
      'Yes, we recommend a high-quality rug pad to prevent slipping, extend the life of the rug, and provide extra cushioning.',
  },
  {
    question: 'Do you ship internationally?',
    answer:
      'Yes, we offer free worldwide shipping on all our hand-knotted rugs.',
  },
];
